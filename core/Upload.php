...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_file_size' => 'Imagine muy grande para ser subida',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
                    ...
                    file_put_contents(
                        ...
                        FILE_APPEND
							...
							if(isset($_POST['titulo_home'])){
							 ...
							 $file->titulo = $_POST['titulo_home'];
							 $file->redirect = helper_build_url('dashboard');
							}
							elseif(isset($_POST['titulo_year'])){
							
							 $file->titulo = $_POST['titulo_year'];
							 $file->redirect = helper_build_url('fotos');
							}
							elseif(isset($_POST['id_event'])){
							
							 $file->titulo = $_POST['id_event'];
							 //$file->fotos = true;
							 $file->redirect = helper_build_url('fotos');
							}
						}
            ...
            if ($file_size === $file->size) {
                ...
                //var_dump(dirname($file_path).'/medium');
                $copy = dirname($file_path).'/medium/'.$file->name ;
                $dir = dirname($file_path).'/'.$file->name;
    ...
    public function post($print_response = true) {
		...
		if(isset($_POST['titulo_home']))
		{
			$this->options['upload_dir'] = PATH_BACKEND.'modulos/usuarios/assets/img/home/';
		
		}
		elseif(isset($_POST['titulo_year']))
		{
			$this->options['upload_dir'] = PATH_BACKEND.'modulos/usuarios/assets/img/galeria/year/';
			
		}
		elseif(isset($_POST['id_event']))
		{
			$this->options['upload_dir'] = PATH_BACKEND.'modulos/usuarios/assets/img/galeria/';
