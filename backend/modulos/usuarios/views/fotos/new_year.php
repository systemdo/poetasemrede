...
<div class="box span6" id="home_nuevo">
	<div class="box-header well" data-original-title>
		<h2><i class="icon-user"></i> Archivos</h2>
	</div>
	<div class="box-content">
	
<form  class="form-horizontal" id="fileupload" action="" method="POST"  enctype="multipart/form-data" data-url="<?php echo helper_build_url('fotos/save_year');?>">
		<div class="control-group">
			<div class="controls" >
			  <label class="control-label" for="Titulo">Titulo </label>	
			  <input type="text" id="inputWarning" name="titulo_year" data-dir="year" value="">
			...
			<div class="row fileupload-buttonbar">
				<div class="span11">
					...
					<span class="btn btn-success subir_meleva fileinput-button" id="subir_year" >
