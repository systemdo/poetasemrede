...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script src="<?php echo M_PATH_JS?>jquery.js?=<?php echo rand();?>"></script>-->
			...
			<link href='<?php echo M_PATH_CSS?>fullcalendar.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>fullcalendar.print.css' rel='stylesheet'  media='print'>
			<link href='<?php echo M_PATH_CSS?>chosen.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>uniform.default.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>colorbox.css' rel='stylesheet'>
	
			<link href='<?php echo M_PATH_CSS?>jquery.noty.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>noty_theme_default.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>elfinder.min.css' rel='stylesheet'>
			<link href='<?php echo M_PATH_CSS?>elfinder.theme.css' rel='stylesheet'>
