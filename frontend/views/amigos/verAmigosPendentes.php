            ...
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p align="center">
                        ...
                        <?php 
                            var_dump($relacionamento->getConvidador());
                        
                            if (!empty($relacionamento->getStatus()) and $relacionamento->getStatus() == StatusModel::STATUS_CONVITE_ENVIADO) { ?>
                            <!--se foi ele que me convidou-->
                            <?php if ($relacionamento->getConvidador()->getIdUser() == $usuario->getId()) { ?>
